...
using ShorcutOpener.Core.Contracts.Services;
using ShorcutOpener.Core.Services;
using ShorcutOpener.Models;
using ShorcutOpener.Services;
...
namespace ShorcutOpener
{
    ...
    public partial class App : Application
    {
        ...
        private async void OnStartup(object sender, StartupEventArgs e)
        {
            ...
            host = Host.CreateDefaultBuilder(e.Args).ConfigureAppConfiguration(c => { c.SetBasePath(appLocation); }).ConfigureServices(ConfigureServices).Build();
